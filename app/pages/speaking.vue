...
const collection = isFr ? 'speaking_fr' : 'speaking'

const { data: page } = await useAsyncData(`speaking-${isFr ? 'fr' : 'en'}`, () => {
...
function formatDate(dateString: string): string {
  return new Date(dateString).toLocaleDateString(isFr ? 'fr-FR' : 'en-US', { year: 'numeric', month: 'long' })
}
</script>
